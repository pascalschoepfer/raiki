...
export default function About() {
  ...
  return (
    <div className="h-screen overflow-hidden bg-gradient-to-br from-[#100c08] via-[#1a1510] to-[#251c15]">
        ...
        <div className="absolute z-10 px-4 sm:px-6 top-[20vh] min-[400px]:top-[20vh] bottom-[15vh] left-0 right-0 sm:inset-0 flex items-center justify-center sm:pt-16 md:pt-8">
