...
export default function DynamicButton({ href, children, className = "" }) {
  ...
  return (
    <a 
      href={href} 
      className={`group bg-[#151210] border-2 border-[#6b6055] px-4 py-3 relative overflow-hidden transition-all duration-200 hover:scale-105 cursor-pointer flex items-center justify-center whitespace-nowrap w-32 ${className}`}
      style={{
